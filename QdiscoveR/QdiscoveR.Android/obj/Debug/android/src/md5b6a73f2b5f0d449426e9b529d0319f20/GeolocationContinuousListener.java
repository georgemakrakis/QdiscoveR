package md5b6a73f2b5f0d449426e9b529d0319f20;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.Geolocator.GeolocationContinuousListener, Plugin.Geolocator, Version=4.1.3.0, Culture=neutral, PublicKeyToken=null", GeolocationContinuousListener.class, __md_methods);
	}
	...
	public GeolocationContinuousListener () throws java.lang.Throwable
	{
		...
		if (getClass () == GeolocationContinuousListener.class)
			mono.android.TypeManager.Activate ("Plugin.Geolocator.GeolocationContinuousListener, Plugin.Geolocator, Version=4.1.3.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
